...
class WatchHistoryUtils {
    ...
    companion object {
        ...
        fun put(key: String, `object`: Any) {
            ...
            val sp = ContextUtil.getContext().getSharedPreferences(
                FILE_NAME,
        ...
        fun getObject(fileName: String, key: String): Any? {
            val sharePre = ContextUtil.getContext().getSharedPreferences(
                fileName,
                Context.MODE_PRIVATE
            )
            try {
                ...
                val objBytes = Base64.decode(
                    wordBase64.toByteArray(),
                    Base64.DEFAULT
                )
