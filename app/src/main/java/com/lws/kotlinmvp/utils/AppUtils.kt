...
class AppUtils private constructor() {
    init {
        throw RuntimeException("Do not need instantiate!")
    }
    ...
    companion object {
         ...
         * 获取应用签名
         */
        fun getSign(context: Context, pakName: String): String? {
            return try {
                val pis = context.packageManager.getPackageInfo(pakName, PackageManager.GET_SIGNATURES)
