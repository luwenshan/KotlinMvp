...
class SearchActivity : MvpActivity<SearchPresenter>() {
    ...
    init {
        //细黑简体字体
        mTextTypeface =
            Typeface.createFromAsset(ContextUtil.getContext().assets, "fonts/FZLanTingHeiS-L-GB-Regular.TTF")
    }
