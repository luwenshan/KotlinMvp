...
import com.lws.kotlinmvp.common.extensions.dataFormat
...
class VideoDetailPresenter : BasePresenter<VideoDetailActivity, MainModel>() {
    ...
    fun loadVideoInfo(itemData: HomeBean.Issue.Item) {
        ...
        //设置背景
        val backgroundUrl =
            itemData.data.cover.blurred + "/thumbnail/${DisplayManager.getScreenHeight()!! - DisplayManager.dip2px(250f)!!}x${DisplayManager.getScreenWidth()}"
