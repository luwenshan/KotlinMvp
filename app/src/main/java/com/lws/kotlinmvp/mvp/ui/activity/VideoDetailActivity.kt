...
import com.lws.kotlinmvp.mvp.presenter.VideoDetailPresenter
import com.lws.kotlinmvp.mvp.ui.adapter.VideoDetailAdapter
import com.lws.kotlinmvp.rx.transformer.SmartRefreshTransformer
import com.lws.kotlinmvp.utils.MLog
import com.lws.kotlinmvp.utils.StatusBarUtil
import com.lws.kotlinmvp.view.VideoListener
...
class VideoDetailActivity : MvpActivity<VideoDetailPresenter>() {
    ...
    override fun <VT> getSmartRefreshTransformer(): ObservableTransformer<VT, VT> =
        SmartRefreshTransformer(mRefreshLayout)
    ...
    override fun addListener() {
        ...
        //当前视频 子Item点击事件
        videoDetailAdapter.onItemChildClickListener =
